...
namespace XRTK.SteamVR.Editor
{
    ...
    public static class SteamVRPluginUtility
    {
        ...
        static SteamVRPluginUtility()
        {
            ...
            if (EditorPreferences.Get($"Reimport_{nameof(SteamVRPluginUtility)}", true))
            {
            ...
            {
                if (EditorPreferences.Get($"SetMeta_{nameof(SteamVRPluginUtility)}", true))
                {
                    SetPluginMeta();
                    EditorPreferences.Set($"SetMeta_{nameof(SteamVRPluginUtility)}", false);
                }
            }
            else
            {
                CopySupportLibraries();
                EditorPreferences.Set($"SetMeta_{nameof(SteamVRPluginUtility)}", true);
